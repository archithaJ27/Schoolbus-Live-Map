...
function App() {
  ...
  const [speed, setSpeed] = useState(2000); // ms between moves

  // We'll keep currentIndex in App state to control vehicle position
  ...
  return (
    <div>
      <h1 style={{ textAlign: 'center', color: '#1240ab' }}>
        School Bus Tracker
      </h1>
